...
- **0.3.0** — Dial up the flavor: full mode now spreads fur through the whole reply (not one marker then plain), emoticons stack on top of markers instead of replacing them, and spicy mode actively reaches for innuendo (1–2 hits/reply) with a calibration example. Tuned after real Opus sessions read too restrained.
